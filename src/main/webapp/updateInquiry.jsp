...
<link rel="stylesheet" href="updateInquiry.css">
...
<body>
  ...
  <form action="update" method="post">
    		...
    		Subject:<br><input type = "text" name ="subject" class="sub-input" required value="<%= subject%>"><br>
    		
    		<label for="message">Inquiry Message:</label><br>
    		
			<textarea id="message" name="message"   rows="4" cols="50" class="msg-input" required><%= message%></textarea><br>
			
			<input type = "submit" name= "submit" value="Update My Data" class="button button1"> <br>
